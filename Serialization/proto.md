...
|2|[astarte_rpc](https://hex.pm/packages/astarte_rpc)|1.2.2|2026-04-24|Astarte platform shared Protocol Buffers .proto files and Elixir AMQP client code.This component is one of the core components and basically is required to allow communication between different Astarte blocks.|152xxx|[![7692](https://img.shields.io/github/stars/astarte-platform/astarte_rpc)](https://github.com/astarte-platform/astarte_rpc)
|3|[protein](https://hex.pm/packages/protein)|0.20.0|2020-01-08|Multi-platform remote procedure call (RPC) system based on Protocol Buffers|51xxx|[![45772](https://img.shields.io/github/stars/surgeventures/protein-elixir)](https://github.com/surgeventures/protein-elixir)
